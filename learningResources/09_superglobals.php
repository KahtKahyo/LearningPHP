...
/* 
    $GET - Contains information about variables passet through a URL or a form.
    $_POST - Contains information about variables passed through a POST request.
...
<html lang="en">
    ...
    <body>
        ...
        <ul>
            ...
            <li>Current File Dir: <?php echo $_SERVER['PHP_SHELF']; ?></li>
